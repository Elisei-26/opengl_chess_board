...
{
    L_Right::L_Right(short moving_shape_mt_coords[]) 
    {
        for (short i = 0; i < 8; ++i) 
        {
    ...
    std::vector<short> L_Right::get_mt_coords_of_shape() const  
    {
        return this->_mt_coords_of_shape;
    }

    void L_Right::rotate_shape(short mt[22][22], short moving_shape_mt_coords[8]) 
    {
